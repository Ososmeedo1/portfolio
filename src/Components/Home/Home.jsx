            ...
            <div className="row align-items-center py-5">
              <div className="col-md-6">
                <div className="content fw-bold text-start py-5">
                  <p>Hey, I'm Osama</p>
                  <h1 className='fw-bold'>Front-end <br /> Developer</h1>
                  <button className='btnBg'>Get In Touch</button>
                </div>
              </div>
              <div className="col-md-6">
        ...
        <div className="row align-items-center justify-content-between w-100">
          ...
          <div className="col-md-8">
            <div className="content text-light text-center py-5">
              ...
              <p className='lead'>I am 20 years old, from Obour City</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="row gy-4">
          ...
          <div className="col-md-4">
            <div className="content">
              ...
              <Link className='btnBg py-1 text-decoration-none' target='_blank' to={`https://e-commerce2210.netlify.app/`}>Visit Site</Link>
            </div>
          </div>
          <div className="col-md-4">
            <div className="content">
